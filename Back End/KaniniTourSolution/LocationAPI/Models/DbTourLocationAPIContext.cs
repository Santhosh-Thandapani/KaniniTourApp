...
{
    public partial class DbTourLocationAPIContext : DbContext
    {
        public DbTourLocationAPIContext()
        {
        }

        public DbTourLocationAPIContext(DbContextOptions<DbTourLocationAPIContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("Data Source=SANTHOSH\\SQLEXPRESS;Integrated Security=true;Initial Catalog=DbTourLocationAPI");
//            }
//        }
